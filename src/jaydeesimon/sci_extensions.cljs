(ns jaydeesimon.sci-extensions
    (:require [jaydeesimon.custom]
              [sci.ctx-store]
              [sci.core :as sci]))
...
(def custom-namespace
  (sci/copy-ns jaydeesimon.custom
               (sci/create-ns 'jaydeesimon.custom)))
...
(def custom-namespaces
  {'jaydeesimon.custom custom-namespace
...
;; `:as` form to a namespace: `(:require [jaydeesimon.custom :as custom])`
(def custom-aliases
  {'custom 'jaydeesimon.custom})
